    ...
    <div class="col-lg-12 <?php echo colormode('default_text') ; ?> ">
        <div class="row p-0">
            <div class="col-lg-12 mb-3 ">
                <h1 class="text-muted"> <i class="bi bi-file-earmark-zip text-primary"></i> <?php echo userlang('total_zip_files') ; ?></h1>
            </div>
            <div class="table-responsive <?php echo colormode('bg_color') ; ?> rounded newShadow">
                ...
                <table class="table table-bordered <?php echo colormode('tbl_dark') ; ?> table-hover cell-border manageZipTable" >
                    <thead>
                        <tr>

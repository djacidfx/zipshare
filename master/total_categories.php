    ...
    <div class="col-lg-12 <?php echo colormode('default_text') ; ?> ">
        <div class="row p-0">
            <div class="col-lg-12 mb-3 ">
                <h1 class="text-muted"> <i class="bi bi-diagram-3-fill text-primary"></i> <?php echo userlang('total_category') ; ?>  <button class="btn btn-success btn-md addCategory"><i class="bi bi-plus me-2"></i><?php echo userlang('category_add') ; ?></button></h1>
            </div>
            <div class="table-responsive p-3 <?php echo colormode('bg_color') ; ?> rounded newShadow">
                ...
                <table class="table table-bordered <?php echo colormode('tbl_dark') ; ?> table-hover cell-border manage_CatTable" >
                    <thead>
                        <tr>

                ...
                <form method="post" class="AdForm">
                    <div class="card <?php echo colormode('bg_color') ; ?> <?php echo colormode('default_text') ; ?> newShadow">
                        <div class="card-header">
                            <h4 class="text-muted"> <i class="bi bi-badge-ad text-success"></i> <?php echo userlang('ad_setting') ; ?></h4>
                        </div>
                        <div class="card-body">
                            <div class="form-group">
                                <label class="text-muted"><?php echo userlang('ad_javascript') ; ?></label>
                                <textarea name="adcode" class="form-control <?php echo colormode('bg_color') ; ?> <?php echo colormode('default_text') ; ?> <?php echo colormode('border') ; ?>" rows="6" required><?php echo find_adcode($pdo) ; ?></textarea>
                            </div>
                            <div class="form-group mt-2">
                                <label class="text-muted"><?php echo userlang('ad_javascript_on') ; ?></label>
                            ...
                            <div class="form-group mt-2">
                                <div class="adcode-messages <?php echo colormode('default_text') ; ?>"></div>
                            </div>
                        </div>
                        <div class="card-footer text-center">
                            <input type="hidden" name="btn_action" value="btnAdCode">

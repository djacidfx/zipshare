...
<?php } ?>
    ...
    <title><?php echo userlang('popular') ; ?> <?php echo userlang('zip_files') ; ?></title>
    <meta property="og:title" content="<?php echo userlang('popular') ; ?> <?php echo userlang('zip_files') ; ?>" />
	<meta property="og:description" content="<?php echo META_SITE_DESCRIPTION ; ?>" />
    <meta property="og:site_name" content="<?php echo BASE_URL ; ?>" />
	<meta property="og:url" content="<?php echo BASE_URL."popular" ; ?>" />
